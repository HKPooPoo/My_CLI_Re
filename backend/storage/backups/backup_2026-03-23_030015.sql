...
\restrict MQzcmKHCwL2mRtxzMR65Fpnelh7V107mQ1XsLSivj1J58jQ6zc4081jepafnOLX
...
859	3	1773985453076	master	1774171378670	1. menu, change language\n\n2. 開關menu from Kitchen\n\n3. 切換時段\nlocalStorage.setItem('timeslot-override', 'morning'); location.reload();\nlocalStorage.removeItem('timeslot-override'); location.reload();\n\n4. Customer Order Step:\n\t1. add to cart\n\t2. choose metadata\n\t3. enter delivery info\n\t4. Stripe checkout\n\t5. 歷史\n\nPo Tin Estate Block 8 1234\nAlan, Yu\n24121627\n24121627a@common.cpce-polyu.edu.hk\n\n5. 厨房訂單\n\n6. 印單\n\n6. 客戶狀態變動 等待外送員\n\n7. 歷史\n\n8. 例如有新的外送員入職\n\n9. 注冊\n\n10 員工列表\n\n11. 員工登入\n\n12. 接單\n\n13. 結單	\N	2026-03-22 09:26:50	2026-03-22 09:26:50
...
SELECT pg_catalog.setval('public.blackboards_id_seq', 859, true);
...
\unrestrict MQzcmKHCwL2mRtxzMR65Fpnelh7V107mQ1XsLSivj1J58jQ6zc4081jepafnOLX
