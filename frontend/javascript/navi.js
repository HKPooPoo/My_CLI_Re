...
function updatePage(subNaviItem) {
    Array.from(document.getElementsByClassName("page")).forEach($page => {
        if (subNaviItem === $page.dataset.page) {
            ...
            // Here update push pull transformY
            ...
            // Abandoned but good idea; single page set its' direction on css is enough
            /*if ($page.classList.contains("page-flex-direction-row")) {
